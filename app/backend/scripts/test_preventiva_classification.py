...
print(f"Total Preventiva questions: {len(questions)}")
...
counts = {}
for q in questions:
    target = classify_prev_question(q["subtema"], q["topic"], q["stem"])
    counts[target] = counts.get(target, 0) + 1

print("\nDistribution across 13 Medway Preventiva Modules:")
