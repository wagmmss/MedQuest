...
har_path = r"C:\Users\wmors\Desktop\Pediatria.har"
...
if focus_sp:
    with open("pediatria_focus_sp.json", "w", encoding="utf-8") as f:
        json.dump(focus_sp, f, ensure_ascii=False, indent=2)
if focus_rp:
    with open("pediatria_focus_rp.json", "w", encoding="utf-8") as f:
...
if modules_data:
    for u, d in modules_data:
        ...
        if isinstance(d, list):
            ...
            with open("pediatria_modules_raw.json", "w", encoding="utf-8") as f:
                json.dump(d, f, ensure_ascii=False, indent=2)
            break

print("Extracted Pediatria HAR successfully!")
