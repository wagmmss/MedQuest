"""
Script para importação de todas as provas do Hospital Sírio-Libanês (HSL 2021 a 2026).
Insere 599 questões no padrão Template Ouro com gabaritos oficiais (A a E) e imagens S3.
"""
...
INST_CODE = "HSL"
INST_LABEL = "Hospital Sírio-Libanês (HSL)"
...
def import_hsl_multi(har_path: str):
