"""
Script para importação de todas as provas da Santa Casa de São Paulo (SCMSP 2020 a 2026).
Insere 700 questões no padrão Template Ouro com gabaritos oficiais (A a E) e imagens S3.
"""
...
INST_CODE = "SCMSP"
INST_LABEL = "Santa Casa de Misericórdia de São Paulo (SCMSP)"
...
def import_scmsp_multi(har_path: str):
