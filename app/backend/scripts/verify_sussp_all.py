...
print("=" * 80)
print(" AUDITORIA CONSOLIDADA: SUS-SP (2020 a 2026 + Autoral)")
print("=" * 80)
...
c.execute("""
    ...
    WHERE q.institution_code = 'SUS-SP'
""")
exp_stats = c.fetchone()
print("-" * 80)
print(f"Total de comentários SUS-SP: {exp_stats['total_exps']}")
