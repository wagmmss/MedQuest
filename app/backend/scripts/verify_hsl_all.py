...
print("=" * 80)
print(" AUDITORIA CONSOLIDADA: HOSPITAL SÍRIO-LIBANÊS (2021 a 2026)")
print("=" * 80)
...
c.execute("""
    ...
    WHERE q.institution_code = 'HSL'
""")
exp_stats = c.fetchone()
print("-" * 80)
print(f"Total de comentários HSL: {exp_stats['total_exps']}")
