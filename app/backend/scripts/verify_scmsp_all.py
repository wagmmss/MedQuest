...
print("=" * 80)
print(" AUDITORIA CONSOLIDADA: SANTA CASA DE SÃO PAULO (2020 a 2026)")
print("=" * 80)
...
c.execute("""
    ...
    WHERE q.institution_code = 'SCMSP'
""")
exp_stats = c.fetchone()
print("-" * 80)
print(f"Total de comentários SCMSP: {exp_stats['total_exps']}")
