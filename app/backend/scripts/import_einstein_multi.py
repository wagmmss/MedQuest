"""
Script para importação de todas as provas do Albert Einstein (2020 a 2026).
Insere 500 questões no padrão Template Ouro com gabaritos oficiais e imagens S3.
"""
...
INST_CODE = "EINSTEIN"
INST_LABEL = "Hospital Israelita Albert Einstein (HIAE)"
...
def import_einstein_multi(har_path: str):
    ...
    for (tid, tname), raw_qs in sorted(test_map.items(), key=lambda x: x[0][1]):
        ...
        # 1. Remover registros anteriores
        cursor.execute("""
    ...
    print(f"\n==================================================")
    print(f"[FINALIZADO] Total de questões EINSTEIN inseridas: {total_inserted}")
    print(f"[FINALIZADO] Total de imagens indexadas: {total_images}")
    print(f"==================================================")

if __name__ == "__main__":
    har_path = r"C:\Users\wmors\Downloads\EINSTEIN_2020-2026.har"
    import_einstein_multi(har_path)
