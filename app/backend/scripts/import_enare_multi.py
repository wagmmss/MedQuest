"""
Script para importação de todas as provas do ENARE (2021 a 2025).
Insere 500 questões no padrão Template Ouro com gabaritos oficiais (A a E) e imagens S3.
"""
...
INST_CODE = "ENARE"
INST_LABEL = "ENARE - Exame Nacional de Residência"
...
def import_enare_multi(har_path: str):
    ...
    print(f"\n==================================================")
    print(f"[FINALIZADO] Total de questões ENARE inseridas: {total_inserted}")
    print(f"[FINALIZADO] Total de imagens indexadas: {total_images}")
    print(f"==================================================")

if __name__ == "__main__":
    har_path = r"C:\Users\wmors\Downloads\ENARE_2021-2025.har"
    import_enare_multi(har_path)
