...
print("=" * 80)
print(" AUDITORIA CONSOLIDADA: ALBERT EINSTEIN (2020 a 2026)")
print("=" * 80)
...
c.execute("""
    ...
    FROM questions
    WHERE institution_code = 'EINSTEIN'
...
c.execute("""
    ...
    WHERE q.institution_code = 'EINSTEIN'
""")
exp_stats = c.fetchone()
print("-" * 80)
print(f"Total de comentários EINSTEIN: {exp_stats['total_exps']}")
