...
const serviceWorker = (await stat(join(root, "public", "sw.js"))).size;
const failures = [];
...
if (serviceWorker > budgets.serviceWorker) failures.push(`service worker ${serviceWorker} > ${budgets.serviceWorker}`);
