...
**Data de geração:** 2026-08-21T01:13:43.237384Z
...
- Questões: 7852
- Questões utilizáveis (`missing_alts=0`): 7798
- Registros em falhas críticas: 216
- Questões na fila humana: 1463
...
- `missing_alts=1` completas (warning): 0
...
- `canonical_subtemas_py`: verified; DB não mapeados=6; catálogo sem questões=0
- `plannerData_json`: verified; DB não mapeados=73; catálogo sem questões=88
...
- `subtema_institution`: total=1131, retornados=200, truncated=true
- `subtema_year`: total=1209, retornados=200, truncated=true
